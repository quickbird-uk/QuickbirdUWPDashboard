    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DataContext>
    {
        ...
        protected override void Seed(DataContext context)
        {
            ...
            Parameter[] parameters =
            {
                ...
                new Parameter {ID = 5, Name = "Level", Unit = "%"}, new Parameter {ID = 6, Name = "Light", Unit = "klx"},
                new Parameter {ID = 7, Name = "Ph", Unit = ""}, new Parameter {ID = 8, Name = "Temp", Unit = "℃"},
            ...
            Placement[] placementTypes =
            {
                ...
                new Placement {ID = 2, Name = "Base Tank"}, new Placement {ID = 3, Name = "Nutrient Tank"},
                new Placement {ID = 4, Name = "Solution Pump"}, new Placement {ID = 5, Name = "Solution Tank"},
                new Placement {ID = 6, Name = "Returning Solution"}, new Placement {ID = 7, Name = "Solution at Plants"},
                new Placement {ID = 8, Name = "Substrate"}, new Placement {ID = 9, Name = "Ambient Outdoors"},
                new Placement {ID = 10, Name = "Ambient Indoors"}, new Placement {ID = 11, Name = "Water Inlet"}
            };
            ...
            {
                new Subsystem {ID = 1, Name = "Acidity"}, new Subsystem {ID = 2, Name = "Climate"},
                new Subsystem {ID = 3, Name = "CO₂"}, new Subsystem {ID = 4, Name = "Light"},
                new Subsystem {ID = 5, Name = "Nutrient"}, new Subsystem {ID = 6, Name = "Oxygen"},
