namespace Quickbird.Migrations
{
    ...
    internal class MainDbContextModelSnapshot : ModelSnapshot
    {
        protected override void BuildModel(ModelBuilder modelBuilder)
        {
            ...
            {
                b.Property<string>("Name").HasAnnotation("MaxLength", 245);
            ...
            modelBuilder.Entity("DbStructure.User.CropCycle", b =>
            {
                ...
                b.Property<string>("CropTypeName").IsRequired();

                b.Property<string>("CropVariety").IsRequired();
            ...
            modelBuilder.Entity("DbStructure.Device",
                b =>
                {
            ...
            modelBuilder.Entity("DbStructure.Global.RelayType",
                b =>
                {
            ...
            modelBuilder.Entity("DbStructure.Sensor", b =>
            {
                ...
                b.HasOne("DbStructure.Global.Placement").WithMany("Sensors").HasForeignKey("PlacementID");
            ...
            modelBuilder.Entity("DbStructure.User.Location",
                b =>
                {
            ...
            modelBuilder.Entity("DbStructure.User.RelayHistory", b =>
            {
                b.HasOne("DbStructure.User.Location", "Location").WithMany("RelayHistory").HasForeignKey("LocationID");
