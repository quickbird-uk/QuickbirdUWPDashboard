namespace Quickbird.Views
{
    ...
    public sealed partial class AnalyticsMode : Page
    {
        ...
        public Dictionary<Guid, FastLineSeries> ChartDictionary = new Dictionary<Guid, FastLineSeries>();
        ...
        /// <summary>Creates a enumerable of string that represent a CSV file. This should return instantly,
        /// the result is a very long lazy linq query.</summary>
        /// <param name="data"></param>
        /// <returns></returns>
        private static IEnumerable<string> ExportDataToCSVQuery(
            IEnumerable<KeyValuePair<Guid, List<KeyValuePair<DateTime, double>>>> data)
        {
        ...
        /// <summary>Can be used before ExportDataToCSV in order to filter the data down.</summary>
        /// <param name="data"></param>
        /// <param name="start"></param>
        /// <param name="end"></param>
        /// <param name="sensors"></param>
        /// <returns></returns>
        private static IEnumerable<KeyValuePair<Guid, List<KeyValuePair<DateTime, double>>>> FilterDataQuery(
            IEnumerable<KeyValuePair<Guid, List<KeyValuePair<DateTime, double>>>> data, DateTimeOffset start,
            DateTimeOffset end, IEnumerable<Guid> sensors)
        {
        ...
        {
            var saver = new FileSavePicker {SuggestedStartLocation = PickerLocationId.DocumentsLibrary};
