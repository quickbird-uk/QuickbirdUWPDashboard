namespace Agronomist.LocalNetworking
{
    ...
    {
        public delegate void DiedEventHandler(Exception e);
        ...
        /// <summary>
        ///     This event is fired when MQTT breaks for any reason.
        ///     Will be used eventually when a logger is implemented.
        /// </summary>
        public event DiedEventHandler MqttDied;
